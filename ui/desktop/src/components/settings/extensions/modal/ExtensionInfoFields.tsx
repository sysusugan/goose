      ...
      <div className="flex justify-between gap-4">
        <div className="flex-1">
          <label className="text-sm font-medium mb-2 block text-text-primary">
            {t('extensions.fields.extensionName')}
          </label>
          <div className="relative">
            ...
            {submitAttempted && !isNameValid() && (
              <div className="absolute text-xs text-red-500 mt-1">
                {t('extensions.fields.nameRequired')}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="w-[200px]">
          ...
          <Select
              ...
              label:
                type === 'stdio'
                  ...
                  : type === 'streamable_http'
                    ? 'HTTP'
                    : type === 'sse'
                      ? t('extensions.fields.unsupportedSse')
                      : type.toUpperCase(),
            }}
            ...
            options={[
              { value: 'stdio', label: t('extensions.fields.standardIo') },
              { value: 'streamable_http', label: t('extensions.fields.streamableHttp') },
            ]}
            isSearchable={false}
          />
        </div>
