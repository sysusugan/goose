        ...
        <div className="bg-background-primary px-8 pb-4 pt-16">
          <div className="flex flex-col page-transition">
            <div className="flex justify-between items-center mb-1">
              <h1 className="text-4xl font-light">{t('extensionsPage.title')}</h1>
            </div>
            <p className="text-sm text-text-secondary mb-2">
              {t('extensionsPage.description', { shortcut: getSearchShortcutText() })}
            </p>
            <p className="text-sm text-text-secondary mb-6">
              {t('extensionsPage.defaultsDescription')}
            </p>
